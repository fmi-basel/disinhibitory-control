# Standard forward ANN vector field
# & no hidden layer control
...
from src.core.vectorfield import ForwardVectorField
...
class FullyConnectedVectorField(ForwardVectorField):
    ...
    def get_initial_state(self, x):
        ...
        state_vf = []
        for i in range(self.nb_hidden):
            state_vf.append(jnp.zeros(sizes[i]))
    ...
    def calculate_jacobian(self, vf_state):
        ...
        return jax.jacrev(surrogate_func)(hidden_layer_state, hidden_layer_derivs)
